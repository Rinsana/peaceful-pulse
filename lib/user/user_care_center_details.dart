...
class _UseCareCenterDetailsState extends State<UseCareCenterDetails> {
  ...
  Future callDoctor(String doctor)async{
    final snapshotDoc= await FirebaseFirestore.instance.collection('Doctors').where('id', isEqualTo: doctor).get();
    doctorDet = snapshotDoc.docs.first.data();
  }
  Future callVolunteer(String volunteer)async{
    final snapshotDoc= await FirebaseFirestore.instance.collection('Volunteer').where('id', isEqualTo: volunteer).get();
    volunteerDet = snapshotDoc.docs.first.data();
  }
  Future callAmbulance(String ambulance)async{
    final snapshotDoc= await FirebaseFirestore.instance.collection('Ambulance').where('id', isEqualTo: ambulance).get();
                                    ...
                                    Column(
                                      children: [
                                        Container(
                                          ...
                                          child: Container(
                                            decoration: BoxDecoration(
                                                image: DecorationImage(image: NetworkImage(doctorDet["Image"]))
                                            ),
                                          ),
                                        ),
                                      ],
                                    ...
                                    Column(
                                      children: [
                                        Container(
                                          ...
                                          child: Container(
                                            decoration: BoxDecoration(
                                                image: DecorationImage(image: NetworkImage(volunteerDet["Image"]))
                                            ),
                                          ),
                                        ),
                                      ],
                                  ...
                                  children: [
                                    Column(
                                      children: [
                                        Container(
                                          ...
                                          child: Container(
                                            decoration: BoxDecoration(
                                                image: DecorationImage(image: NetworkImage(ambulanceDet["Image"]))
                                            ),
                                          ),
                                        ),
                                      ],
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        TextButton(
                                          onPressed: () {
                                            FlutterPhoneDirectCaller.callNumber(ambulanceDet["Phone"]);
                                          },
                                          style: TextButton.styleFrom(
                                              shape: RoundedRectangleBorder(
                                                  borderRadius:
